...
function validarComensales(){
	...
	if(!comensales.checkValidity()){
		...
		if(comensales.validity.rangeOverflow){
			error2(numero, "Error: Numero de comensales por encima de lo permitido");
			return false;
		}
		if(comensales.validity.rangeUnderflow){
			error2(numero, "Error: Numero de comensales inferior de lo permitido");
			return false;
		}
	}
	return true;
